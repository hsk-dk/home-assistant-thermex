...
from .api import ThermexAPI, ThermexAuthError
...
class ThermexConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_reauth_confirm(self, user_input=None):
        ...
        return self.async_show_form(step_id="reauth_confirm", data_schema=vol.Schema({vol.Required("password"): str}), errors=errors)
